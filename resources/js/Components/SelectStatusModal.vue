            ...
            <div class="modal-wrapper">
                <div class="modal-container">
                    <div class="modal-body grid gap-4">
                        <button class="bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded" @click="$emit('status', 'nouveau')" >
                            Nouveau
                        </button>
                        <button class="bg-orange-500 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded" @click="$emit('status', 'option')" >
                            Option
                        </button>
